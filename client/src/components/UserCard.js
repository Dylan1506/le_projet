...
const UserCard = ({ toggleUpdateUser }) => {
  return (
    <article class="flex max-w-[500px] items-center gap-2 rounded-xl border-2 border-gray-100 bg-white p-2">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600">pridila.2006@gmail.com</p>
      </div>
