    ...
    <section className="bg-gray-100">
      <div className="mx-auto max-w-screen-2xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="items-end justify-between sm:flex">
          ...
          <a
            href="/"
            className="mt-8 inline-flex shrink-0 items-center gap-2 rounded-full border border-teal-600 px-5 py-3 font-medium text-teal-600 hover:bg-teal-600 hover:text-white sm:mt-0 lg:mt-8"
          >
            Read all reviews
            <svg
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <blockquote className="flex h-full flex-col justify-between bg-white p-12">
            <div>
              ...
              <div className="mt-4">
                <h3 className="text-xl font-bold text-teal-600 sm:text-2xl">
